    ...
    if ($valid)
    {
		...
		else if($users)
		{
			...
			if($user == 1)
			{
				...
				if($newOutfitter)
				{
					header( 'Location: /Outfitters/linkOutfitter.php' );
				}
				else
				{
...
<form class="form-horizontal row-border" action="createUser.php" method="post">
					...
					<div class="form-group">
						<div class="col-md-2 col-md-offset-5">
							<button type="submit" class="btn btn-success btn-success-custom">sign up!</button>
						</div>
					</div>
...
{
?>
			<div class="col-md-6 col-md-offset-3 inlineblock alert alert-danger" role="alert">
